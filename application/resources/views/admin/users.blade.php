@extends('layouts.default')
    ...
    @section('meta')
        <title>Users | Log Tracker</title>
        <meta name="description" content="Log Tracker users, view all users, add, edit, delete users">
    @endsection 
                        ...
                        <tbody>
                           @isset($users_roles)
                            ...
                            <tr>
                                ...
                                <td>{{ $val->email }}</td>
                                <td>{{ $val->role_name }}</td>
                                <td> @if($val->acc_type == 2) Admin @else Student @endif </td>
                                <td>
                                    <span>
                                    @if($val->status == '1') 
                                        Enabled
