@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">{{ __("Student Attendance Report") }}
                    ...
                    <form action="{{ url('export/report/attendance') }}" method="post" accept-charset="utf-8" class="ui small form form-filter" id="filterform">
                        ...
                        <div class="inline three fields">
                            <div class="three wide field">
                                <select name="student" class="ui search dropdown getid">
    ...
    $('#btnfilter').click(function(event) {
        ...
        $.ajax({
            url: url + '/get/student-attendance/', type: 'get', dataType: 'json', data: {id: emp_id, datefrom: date_from, dateto: date_to}, headers: { 'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content') },
