@extends('layouts.default')
    ...
    @section('meta')
        <title>Edit User | Log Tracker</title>
        <meta name="description" content="Log Tracker edit user.">
    @endsection 
                    ...
                    <div class="box-content">
                        ...
                        <form id="edit_user_form" action="{{ url('users/update/user') }}" class="ui form add-user" method="post" accept-charset="utf-8">
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="student" value="@isset($u->name){{ $u->name }}@endisset" class="readonly uppercase" readonly>
                            </div>
                            <div class="field">
