<?php
/*
* Workday - A time clock application for students
		...
		*/
		...
		Route::group(['middleware' => 'admin'], function () {
			...
			*/
			...
			Route::get('students/new', 'Admin\StudentsController@new');
			Route::post('student/add',  'Admin\StudentsController@add');
			...
			*/
			...
			Route::post('profile/delete/student', 'Admin\ProfileController@clear');
			...
			*/
			...
			Route::get('reports/student-list', 'Admin\ReportsController@empList');
			Route::get('reports/student-attendance', 'Admin\ReportsController@empAtten');
			Route::get('reports/individual-attendance', 'Admin\ReportsController@indiAtten');
			Route::get('reports/student-leaves', 'Admin\ReportsController@empLeaves');
			Route::get('reports/individual-leaves', 'Admin\ReportsController@indiLeaves');
			Route::get('reports/student-schedule', 'Admin\ReportsController@empSched');
			Route::get('reports/organization-profile', 'Admin\ReportsController@orgProfile');
			Route::get('reports/student-birthdays', 'Admin\ReportsController@empBday');
			Route::get('reports/user-accounts', 'Admin\ReportsController@userAccs');
			Route::get('get/student-attendance', 'Admin\ReportsController@getEmpAtten');
			Route::get('get/student-leaves', 'Admin\ReportsController@getEmpLeav');
			Route::get('get/student-schedules', 'Admin\ReportsController@getEmpSched');
			...
			*/
			// school
			Route::get('fields/school/', 'Admin\FieldsController@school')->name('school');
			Route::post('fields/school/add', 'Admin\FieldsController@addschool');
			Route::get('fields/school/delete/{id}', 'Admin\FieldsController@deleteschool');

			// grade
			Route::get('fields/grade', 'Admin\FieldsController@grade')->name('grade');
			Route::post('fields/grade/add', 'Admin\FieldsController@addgrade');
			Route::get('fields/grade/delete/{id}', 'Admin\FieldsController@deletegrade');
			...
			*/
			// export
			Route::get('export/fields/school', 'Admin\ExportsController@school');
			Route::get('export/fields/grade', 'Admin\ExportsController@grade');
			...
			// import
			Route::post('import/fields/school', 'Admin\ImportsController@importschool');
			Route::post('import/fields/grade', 'Admin\ImportsController@importgrade');
			...
			// reports export
			Route::get('export/report/students', 'Admin\ExportsController@studentList');
		...
		Route::group(['middleware' => 'student'], function () {
			/*
			|--------------------------------------------------------------------------
			| student Frontend : Dashboard, Profile, Attendance, Schedules, Leaves, Settings
			|--------------------------------------------------------------------------
			*/
			// dashboard 
