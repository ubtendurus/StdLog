...
class AttendanceController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('admin.attendance', compact('data', 'ss', 'students', 'tf', 'cc'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('attendance')->with('success', trans("student attendance has been updated!"));
    }
    ...
    public function addEntry(Request $request)
    {
        ...
        $emp_id = table::schooldata()->where('id', $reference)->value('reference');
        $emp_idno = table::schooldata()->where('id', $reference)->value('idno');
        
        if($emp_id == null || $emp_idno == null) {
            return redirect('attendance')->with('error', trans("student is not found."));
        }
        ...
        if ($timeout == null) 
        {
            ...
            if ($has == 1) 
            {
                ...
                return redirect('attendance')->with('error', trans("The student already clock in today at")." ".$hti_24);
                ...
                return redirect('attendance')->with('success', trans("student attendance has been added!"));
            }
        }
    ...
    public function getFilter(Request $request) 
	{
		...
		{
			$data = table::attendance()->select('id', 'idno', 'date', 'student', 'timein', 'timeout', 'totalhours', 'comment', 'status_timein', 'status_timeout')->get();
			return response()->json($data);
		}

        if ($datefrom !== null AND $dateto !== null) 
        {
			$data = table::attendance()->whereBetween('date', [$datefrom, $dateto])->select('id', 'idno', 'date', 'student', 'timein', 'timeout', 'totalhours', 'comment', 'status_timein', 'status_timeout')->get();
			return response()->json($data);
		} 
	}
}
