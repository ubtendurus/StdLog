...
class ImportsController extends Controller
{
	...
	function importschool(Request $request) 
	{
		...
		if ($uploadedfile != null) 
		{
			...
			{
				table::school()->insert([
					[ 'id' => $value[0], 'school' => $value[1] ],
				]);
			}

			return redirect('fields/school');
		} else {
			return redirect('fields/school')->with('error', trans("Whoops!, Please upload a csv file."));
		}
	}
	...
	function importgrade(Request $request) 
	{
		...
		if ($uploadedfile != null) 
		{
			...
			{
				table::grade()->insert([
					[ 'id' => $value[0], 'grade' => $value[1] ],
				]);
			}

			return redirect('fields/grade');
		} else {
			return redirect('fields/grade')->with('error', trans("Whoops!, Please upload a csv file."));
		}
	}
