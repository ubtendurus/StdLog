                        ...
                        <ul class="nav navbar-nav ml-auto navmenu">
                            ...
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    ...
                                    <i class="dropdown icon"></i>
                                    <div class="menu" tabindex="-1">
                                      <a href="{{ url('clock') }}" target="_blank" class="item"><i class="ui icon clock outline"></i>{{ __('Check In/Out') }}</a>
                                      <div class="divider"></div>
                                      <a href="{{ url('students/new') }}" class="item"><i class="ui icon user plus"></i>{{ __('New student') }}</a>
                                      <div class="divider"></div>
                                      <a href="{{ url('fields/school') }}" class="item"><i class="ui icon university"></i>{{ __('School') }}</a>
                                      <a href="{{ url('fields/grade') }}" class="item"><i class="ui icon cubes"></i>{{ __('Grade') }}</a>
