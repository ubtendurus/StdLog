<div class="ui modal medium add">
    <div class="header">{{ __("Add Student Log") }}</div>
    <div class="content">
        ...
        <div class="field">
            <label for="">{{ __("Check IN") }} <span class="help">(required)</span></label>
            <input class="jtimepicker" type="text" placeholder="00:00:00 AM" name="timein" value="" required>
        </div>
        <div class="field">
            <label for="">{{ __("Check OUT") }} <span class="help">(optional)</span></label>
