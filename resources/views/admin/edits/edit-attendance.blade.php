@extends('layouts.default')
    ...
    @section('meta')
        <title>Edit student Attendance | Log Tracker</title>
        <meta name="description" content="Log Tracker edit student attendance.">
    @endsection 
                    ...
                    @if($a->timeout != null)
                        <div class="two fields">
                            <div class="field">
                                ...
                                <input type="text" name="student" class="readonly" readonly="" value="@isset($a->student){{ $a->student }}@endisset">
                            </div>
                            <div class="field">
