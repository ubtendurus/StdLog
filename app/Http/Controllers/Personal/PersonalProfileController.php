...
class PersonalProfileController extends Controller
{
	public function index() 
	{
		...
		$school_data = table::schooldata()->where('reference', $id)->first();
        ...
        return view('personal.personal-profile-view', compact('profile', 'school_data', 'profile_photo', 'leavetype', 'leavegroup'));
    }
